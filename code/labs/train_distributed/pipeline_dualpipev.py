"""Dispatcher for baseline vs optimized DualPipeV demos (single-GPU simulation)."""
...
def main():
    parser = argparse.ArgumentParser(description="DualPipeV toy pipeline (single-GPU simulation).")
