...
# Lightweight fallbacks when optional deps are unavailable
if rustbpe is None:
    class _RustBPEStub:
        class Tokenizer:
            def __init__(self, pattern: str = SPLIT_PATTERN):
            ...
            def encode(self, text: str):
                return self._tok.encode_ordinary(text) if self._tok is not None else []
...
if tiktoken is None:
    ...
    class _TiktokenStub:
        ...
        def get_encoding(self, name: str):
            return _EncodingStub(name=name, pat_str=SPLIT_PATTERN, mergeable_ranks={}, special_tokens={})
